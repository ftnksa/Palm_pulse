...
class BluetoothDeviceListEntry extends ListTile {
  BluetoothDeviceListEntry({
    ...
    enabled: enabled,
    leading: Icon(Icons
        .bluetooth_connected_rounded), // @TODO . !BluetoothClass! class aware icon
...
class _MainPage extends State<MainPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Center(child: const Text('أضافة جهاز جديد')),
      ),
                ...
                children: [
                  ...
                  ListTile(
                    title: ElevatedButton(
                      child: const Text('الاتصال بالجهاز المقترن'),
                      onPressed: () async {
...
class _SelectBondedDevicePage extends State<SelectBondedDevicePage> {
  ...
  void initState() {
    ...
    FlutterBluetoothSerial.instance
      ...
      setState(() {
        bondedDevices = bondedDevices.where((d) => d.name == "HC-05").toList();
